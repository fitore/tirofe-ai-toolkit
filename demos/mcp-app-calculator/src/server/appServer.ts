...
import { checkReverseMortgageEligibility, type EligibilityInput } from "../shared/eligibility.js";
...
export function registerReverseMortgageApp(server: McpServer): void {
  registerAppTool(
    ...
    toolName,
    {
      ...
      description:
        "Returns illustrative, non-underwriting reverse mortgage eligibility and estimate JSON for a personal local demo.",
